...
_STAGE_INTERVAL_EVENTS = (
    ...
    ("scheduler_prefill_start", "scheduler_result_enqueued"),
    ("scheduler_model_execute_start", "scheduler_model_execute_end"),
    ("scheduler_prefill_execute_start", "scheduler_prefill_execute_end"),
    ("scheduler_decode_execute_start", "scheduler_decode_execute_end"),
    ("scheduler_other_execute_start", "scheduler_other_execute_end"),
    ("scheduler_result_adapter_start", "scheduler_result_adapter_end"),
    ("scheduler_result_enqueued", "stage_complete"),
